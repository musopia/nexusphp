...
<?php
	...
	print("<form action='shoutbox.php' method='get' target='sbox' name='shbox' autocomplete='off'>\n");
    print('<div class="shout-composer" style="display: flex">');
	print("<label for='shbox_text'>".$lang_index['text_message']."</label><input type='text' name='shbox_text' id='shbox_text' size='100' autocomplete='off' autocorrect='off' autocapitalize='off' spellcheck='false' style='flex-grow: 1; border: 1px solid gray;' />  <input type='submit' id='hbsubmit' class='btn' name='shout' value=\"".$lang_index['sumbit_shout']."\" />");
